...
- None of the flagged decisions may be batch-approved; each needs the user's individual sign-off at the checkpoint, same discipline as `$CLAUDE_PLUGIN_ROOT/docs/decisions/0001-migration-fork-proactive-flagging.md`.
